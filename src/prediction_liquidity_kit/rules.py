...
def evaluate_kalshi_liquidity(inputs: Mapping[str, object]) -> dict[str, Decimal]:
    ...
    user_period_score = _positive(inputs.get("user_period_score"), "user_period_score")
...
def evaluate_kalshi_volume(inputs: Mapping[str, object]) -> dict[str, Decimal]:
    ...
    user_contracts = _positive(inputs.get("user_eligible_contracts"), "user_eligible_contracts")
